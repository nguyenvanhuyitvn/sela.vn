    ...
    <div class="row">
        <div class="col-md-4">
            <div class="col-md-12 col-xs-12 col-12">
                ...
                <form id="category" method='post' action="{{route('admin.category.update', ['id' => $cate->id])}}"> 
                @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name" placeholder="Tên danh mục" value="{{$cate->name}}">
                            @if($errors->has('name'))	
